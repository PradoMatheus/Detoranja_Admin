<nav class="navbar navbar-dark bg-dark flex-md-nowrap p-0 shadow">
	<div class="d-flex justify-content-center">
		<a class="navbar-brand" href="#">Detoranja Administrador</a>
	</div>
	<div class="d-flex justify-content-end">
		<ul class="navbar-nav px-3">
			<li class="nav-item text-nowrap"><a class="nav-link" href="#">Sair</a>
			</li>
		</ul>
	</div>
</nav>
			...
			<div class="sidebar-sticky">
				<ul class="nav flex-column">
					...
					<li class="nav-item"><a class="nav-link" href="#"> <svg
								...
								<polyline points="2 12 12 17 22 12"></polyline></svg> Integrações
					</a></li>
				</ul>
				...
				<ul class="nav flex-column mb-2">
					<li class="nav-item"><a class="nav-link" href="#"> <svg
								...
								<polyline points="10 9 9 9 8 9"></polyline></svg> Neste mês
					</a></li>
					<li class="nav-item"><a class="nav-link" href="#"> <svg
								xmlns="http://www.w3.org/2000/svg" width="24" height="24"
								viewBox="0 0 24 24" fill="none" stroke="currentColor"
								...
								<line x1="16" y1="13" x2="8" y2="13"></line>
								<line x1="16" y1="17" x2="8" y2="17"></line>
								<polyline points="10 9 9 9 8 9"></polyline></svg> Último trimestre
					</a></li>
				</ul>
			</div>
		</nav>
